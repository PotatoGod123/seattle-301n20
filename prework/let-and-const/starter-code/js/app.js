...
function displayPics(){
  ...
  // The reason for getting a referenceError is because the rando decleation is a const now and since it's being used inside a codeblock it can only 
  // scoped inside that codeblock, so when it gets to the console.log(rando); the rando variable does not exist
